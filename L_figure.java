...
public class L_figure extends Figures {
    static int pos;
    static void rotate() {
        boolean flag = true;
        try {
        ...
        if (flag) {
            switch (pos){
                case 0: {
                    changepos(0,0,0,0,0,2,2,2,2);
                    pos = 1;
                    break;
                }
                case 1:{
                    changepos(0,2,2,0,0,2,0,0,2);
                    pos = 2;
                    break;
                }
                case 2:{
                    changepos(2,2,2,2,0,0,0,0,0);
                    pos = 3;
                    break;
                }
                case 3:{
                    changepos(2,0,0,2,0,0,2,2,0);
                    pos = 0;
                    break;
                }
            }
    ...
    public void drawfigure(Graphics g,int x,int y) {
        ...
        switch (pos) {
            ...
            case 1: {
                g.fillRect(x+60, y+30, 30, 30);
                g.fillRect(x, y + 60, 90, 30);
                break;
            }
            case 2: {
